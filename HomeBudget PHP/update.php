...
if(isset($_POST['update_settings']) && isset($_POST['update_settings_auto_savings'])
        && isset($_POST['update_settings_auto_delete']) && isset($_POST['update_settings_auto_local_save'])){
    $response = array();
    $mysql->connect();
    $result = $mysql->updateSettings($_POST['update_settings'], $tab_bool[$_POST['update_settings_auto_savings']],
            $tab_bool[$_POST['update_settings_auto_delete']], $tab_bool[$_POST['update_settings_auto_local_save']]);
    if($result === true){
        $response['response_value'] = 1;
